...
MapGraphicsObject::MapGraphicsObject(bool sizeIsZoomInvariant, MapGraphicsObject *parent) :
    _sizeIsZoomInvariant(sizeIsZoomInvariant), _enabled(true), _opacity(1.0), _pos(QPointF(0.0, 0.0)),
    _rotation(0.0), _visible(true), _zValue(0.0), _selected(false), _constructed(false)
{
...
void MapGraphicsObject::setZoomLevel(const quint16 &zoomLevel)
{
    Q_UNUSED(zoomLevel);
}
